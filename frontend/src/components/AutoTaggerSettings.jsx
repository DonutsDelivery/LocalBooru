...
export default function AutoTaggerSettings() {
  ...
  const legacyActiveProvider = health?.active_provider && formatProvider(health.active_provider)
  ...
  return (
    <section className="optical-flow-settings">
      ...
      <section className="settings-section">
        ...
        {legacyActiveProvider && <p className="setting-note">Legacy active provider: {legacyActiveProvider}</p>}
